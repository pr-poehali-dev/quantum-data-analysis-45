const services = [
  { icon: "🌑", title: "Снятие порчи и сглаза", desc: "Очищение энергетики, защита от негативных воздействий", price: "от 3 000 ₽" },
  { icon: "🔮", title: "Расклады Таро", desc: "Ответы на вопросы о судьбе, любви, финансах и здоровье", price: "от 1 500 ₽" },
  { icon: "💫", title: "Приворот / Отворот", desc: "Работа с отношениями и любовной сферой", price: "от 5 000 ₽" },
  { icon: "🌿", title: "Исцеление", desc: "Восстановление здоровья через энергетические практики и травы", price: "от 2 500 ₽" },
  { icon: "🧿", title: "Защита и оберег", desc: "Создание индивидуального оберега для вас и вашего дома", price: "от 2 000 ₽" },
  { icon: "🌙", title: "Работа с родом", desc: "Снятие родовых проклятий, исцеление родовых программ", price: "от 7 000 ₽" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-neutral-800">
          {services.map((s) => (
            <div key={s.title} className="bg-neutral-950 p-8 flex flex-col gap-3 hover:bg-neutral-900 transition-colors duration-300">
              ...
              <p className="text-neutral-300 text-sm font-medium">{s.price}</p>
            </div>
          ))}
        </div>
